...
$(document).ready(function() {
	...
	$("#mainmenu").html("<div class=\"menulist\">" +
				...
				"</div>" +
				"<hr>" +
					"<script type=\"text/javascript\" id=\"clustrmaps\" src=\"//cdn.clustrmaps.com/map_v2.js?cl=ffffff&w=a&t=tt&d=2MAtWut9LH7lh-B1sQLqIbylbTqh4tSwQyno2E1RAEQ&co=0087d4\"></script>" +
			"</div>");
