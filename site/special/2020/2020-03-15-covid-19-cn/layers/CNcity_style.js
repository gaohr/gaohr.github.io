...
[9.000000, 49.000000, [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: "rgba(55,55,55,0.25)", width: 0}) , fill: new ol.style.Fill({color: "rgba(255,215,185,1.0)"})
    })]],
[49.000000, 99.000000, [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: "rgba(55,55,55,0.25)", width: 0}) , fill: new ol.style.Fill({color: "rgba(255,195,145,1.0)"})
    })]],
[99.000000, 249.000000, [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: "rgba(55,55,55,0.25)", width: 0}) , fill: new ol.style.Fill({color: "rgba(250,155,100,1.0)"})
    })]],
[249.000000, 499.000000, [ new ol.style.Style({
...
[499.000000, 999.000000, [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: "rgba(55,55,55,0.25)", width: 0}) , fill: new ol.style.Fill({color: "rgba(225,95,50,1.0)"})
    })]],
