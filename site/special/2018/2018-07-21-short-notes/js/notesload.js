...
for(i = 0; i < noteslist.length; i++) {
	...
	$("#zturn").append(
		...
		"	<p class=\"label\">" + noteslist[i].type + "</p>" +
			"<div class=\"info\"><span class=\"info-author\"><i class=\"icon-user\"></i>" + noteslist[i].author + "</span>于<span class=\"info-loc\">" + noteslist[i].loc + "</span><span class=\"info-date\">[" + noteslist[i].date + "]</span></div>" +
